...
public class CTest extends TestCase {
	...
	public void tm() throws Exception {
		C c = CFactory.makeC(Locale.US);
		OtherClass var2 = new OtherSubClass1('v', "verbose"); 
		c.m1(var2);
		OtherClass var3 = new OtherSubClass2('s', "size"); 
		c.m1(var3);
		OtherClass var4 = new OtherSubClass3('n', "name"); 
		c.m1(var4);
		OtherClass var5 = new OtherSubClass4('f', "fraction"); 
		c.m1(var5);
		OtherClass var6 = new OtherSubClass1('m', "missing"); 
		c.m1(var6);
		OtherClass var7 = new OtherSubClass1("careful");
		c.m1(var7);
		OtherClass var8 = new OtherSubClass5('b', "bignum"); 
		c.m1(var8);
		
		assertEquals(null, c.m6(var3).getValue());
		Long var9 = new Long(new Long(Integer.MAX_VALUE).longValue() + 1);
		c.m7("-v --size=100 -b " + var9.toString() + " -n foo -f 0.1 rest");
		
		assertEquals(null, c.m6(var6).getValue());
		assertEquals(Boolean.TRUE, c.m6(var2).getValue());
		assertEquals(100, ((Integer) c.m6(var3).getValue()).intValue());
		assertEquals("foo", c.m6(var4).getValue());
		assertEquals(var9, c.m6(var8).getValue());
		assertEquals(0.1, ((Double) c.m6(var5).getValue())
				.doubleValue(), 0.1e-6);
	}
