...
public class CTest extends TestCase {
	...
	public void tm() throws Exception {
		C c = new C();
		C.InnerClass var2 = c.m1('v', "verbose");
		C.InnerClass var3 = c.m2('s', "size");
		C.InnerClass var4 = c.m3('n', "name");
		C.InnerClass var5 = c.m4('f', "fraction");
		C.InnerClass var6 = c.m1('m', "missing");
		C.InnerClass var7 = c.m1("careful");
		C.InnerClass var8 = c.m5('b', "bignum");
		assertEquals(null, c.m6(var3));
		Long var9 = new Long(new Long(Integer.MAX_VALUE).longValue() + 1);
		c.m7(new String[] { "-v", "--size=100", "-b",
				var9.toString(), "-n", "foo", "-f", "0.1", "rest" },
				Locale.US);
		assertEquals(null, c.m6(var6));
		assertEquals(Boolean.TRUE, c.m6(var2));
		assertEquals(100, ((Integer) c.m6(var3)).intValue());
		assertEquals("foo", c.m6(var4));
		assertEquals(var9, c.m6(var8));
		assertEquals(0.1, ((Double) c.m6(var5))
				.doubleValue(), 0.1e-6);
		assertArrayEquals(new String[]{"rest"}, c.m8());
	}
