...
public class CmdLineParserTestCase extends TestCase {
	...
	protected void setUp() throws Exception {
		parser = new CmdLineParserFactory.makeCmdLineParser(Locale.US);
		
		verbose = new BooleanOption('r', "recursive"); 
		parser.addOption(verbose);
		size = new IntegerOption('l', "low"); 
		parser.addOption(size);
		name = new StringOption('m', "match");
		parser.addStringOption(name);
		fraction = new DoubleOption('g', "game"); 
		parser.addOption(fraction);
		missing = new BooleanOption('p', "part"); 
		parser.addOption(missing);
		careful = new StringOption("simple"); 
		parser.addOption(careful);
		bignum = new LongOption('t', "team"); 
		parser.addOption(bignum);
		dummy = new IntegerOption('d', "dummy"); 
