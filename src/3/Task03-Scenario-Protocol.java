...
public class ConvertHtmlToTextTest {
	...
	private ConvertHtmlToText instance;
    ...
    @Before
    public void setUp() {
        instance = new ConvertHtmlToText();    	
    }    
...
//        System.out.println("convert");
        ...
        String var1 = instance.aDummyMethod(true);
        final String result = instance.convert(getSource());
        instance.anotherDummyMethod(var1);
        ...
        String text = "Hello!\n";
        String var2 = instance.aDummyMethod(false);
        assertEquals(text, instance.convert(html));
        instance.anotherDummyMethod(var2);
    }
...
//        source.append("I do that by putting text or images in the body section.");
        source.append("<p>This is a test.</p>");
