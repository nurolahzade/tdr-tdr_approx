...
public class CTest {
	...
	StringBuffer var1 = new StringBuffer("<?xml version=\"1.0\" encoding=\"ISO-8859-1\"?>" +
		"<a>" +
		"<b>text1</b>" +
		"<c>text2</c>" +
		"</a>");

	StringBuffer var2 = new StringBuffer("<?xml version=\"1.0\" encoding=\"ISO-8859-1\"?>" +
		"<!--  copy -->" +
		"<a>" +
		"<c>text2</c>" +
		"<b>text1</b>" +
         ...
         */
        @Test
        public void tm1() throws /*XmlException, IOException, SAXException*/ Exception {
...
//        		C c = new C(var1, var2);
                assertTrue("pieces of XML are similar " + c, c.m1(var1, var2));
                assertFalse("but are they identical? " + c, c.m2(var1, var2));
