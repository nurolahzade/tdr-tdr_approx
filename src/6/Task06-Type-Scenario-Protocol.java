...
public class TestXmlDiff {
	...
	@Before
	public void setUp() {
		xml1 = new StringBuffer("<?xml version=\"1.0\" encoding=\"ISO-8859-1\"?>" +
			"<a>" +
			"<b>text1</b>" +
			"<c>text2</c>" +
			"<!-- comment -->" +
		...
		xml2 = new StringBuffer("<?xml version=\"1.0\" encoding=\"ISO-8859-1\"?>" +
			"<!--  copy -->" +
			"<a>" +
			"<c>text2</c>" +
			"<b>text1</b>" +
		...
		xml3 = new StringBuffer("<?xml version=\"1.0\" encoding=\"ISO-8859-1\"?>" +
			"<!--  copy -->" +
         ...
         */
        @Test
        public void testDiff() throws /*XmlException, IOException, SAXException*/ Exception {
...
//        		Diff myDiff = new Diff(xml1, xml2);
                assertTrue(MyDiff.similar(xml1, xml2));
                assertFalse(MyDiff.identical(xml1, xml2));

//                myDiff = new Diff(xml2, xml3);
                assertTrue(MyDiff.similar(xml2, xml3));
                assertTrue(MyDiff.identical(xml2, xml3));
