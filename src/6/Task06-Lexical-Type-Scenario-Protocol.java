...
public class CTest {
	...
	@Before
	public void setUp() {
		var1 = new StringBuffer("<?xml version=\"1.0\" encoding=\"ISO-8859-1\"?>" +
			"<a>" +
			"<b>text1</b>" +
			"<c>text2</c>" +
			"<!-- comment -->" +
		...
		var2 = new StringBuffer("<?xml version=\"1.0\" encoding=\"ISO-8859-1\"?>" +
			"<!--  copy -->" +
			"<a>" +
			"<c>text2</c>" +
			"<b>text1</b>" +
		...
		var3 = new StringBuffer("<?xml version=\"1.0\" encoding=\"ISO-8859-1\"?>" +
			"<!--  copy -->" +
